#!/usr/bin/env bash
# ==========================================================================
# Layer-wise Membrane-Aware Reconstruction Ablation (CIFAR10)
# ==========================================================================
...
#
# Usage:
#   ./exp/cifar10/run_recon_ablation.sh
#   GROUP=mem   ./exp/cifar10/run_recon_ablation.sh
#   GPU=7       ./exp/cifar10/run_recon_ablation.sh
#
# Groups:
...
for spec in "${EXPS[@]}"; do
  ...
  tmp="$(mktemp "${TMPDIR:-/tmp}/ptq_cifar10_recon_${tag}.XXXXXX.yml")"
  cp "${BASE_CONFIG}" "${tmp}"
